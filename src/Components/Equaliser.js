...
class AudioSpectrum extends Component {
  constructor(props){
        ...
        let cont = this.props.sound
        cont = new Audio(cont);
        this.prevProps = new Audio(this.props);
    }
    ...
    render() {
        return (
           ...
           <div class="accordion-title"><span>How to use</span></div>
           <div class="accordion-content"></div>
                <input type="radio" name="select" class="accordion-select" />
           <div class="accordion-title"><span>Visualiser</span></div>
